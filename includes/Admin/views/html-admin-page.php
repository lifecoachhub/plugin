	...
	<div class="wrap lifecoachhub-admin-wrap">
		<div class="lifecoachhub-welcome-container">
			...
			<div class="lifecoachhub-cta">
				...
				<div class="cta-buttons cta-buttons-secondary">
					<p class="cta-secondary-text">
						<?php esc_html_e('Wanna Access the full platform directly in your browser?', 'lifecoachhub'); ?>
					</p>
				</div>
				<div class="cta-buttons-tertiary">
					<a href="<?php echo esc_url(LIFECOACHHUB_APP_URL); ?>" class="button button-text button-hero" target="_blank">
